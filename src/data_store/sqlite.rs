...
impl SqliteUserStore {
    ...
    fn update_user_full<'a>(
        ...
        diesel::update(users.find(id))
            ...
            .map(|_| ())
            .map_err(|e| Error::Unknown(format!("Failed to find user {}: {}", id, e)))
    }
}
...
impl UserStore for SqliteUserStore {
    fn create_user<'a>(
        ...
        self.sqlite_conn
            ...
            .map(Into::into)
            .map_err(|e| Error::Unknown(format!("Error saving new user: {}", e)))
    }
    ...
    fn filter_users(&self, count: i32) -> Result<Vec<User>> {
        ...
        Ok(users
            ...
            .map_err(|e| Error::Unknown(format!("Failed to users from DB: {}", e)))?
            .into_iter()
            .map(|u| u.into())
            .collect())
    }
    ...
    fn delete_user(&mut self, id: i32) -> Result<()> {
        ...
        diesel::delete(dsl::users.filter(dsl::id.eq(id)))
            .execute(self.sqlite_conn.as_ref())
            .map(|_| ())
            .map_err(|e| Error::Unknown(format!("Failed to delete user in DB: {}", e)))
    }
}
...
impl SqliteSavedItemStore {
    ...
    fn get_saved_items_by_user(&self, user_id: i32) -> Result<Vec<SavedItem>> {
        ...
        dsl::saved_items
            ...
            .map_err(|e| Error::Unknown(format!("Failed to get saved items from DB: {}", e)))
    }
}
...
impl SavedItemStore for SqliteSavedItemStore {
    fn create_saved_item<'a>(
        ...
        self.sqlite_conn
            ...
            .map(Into::into)
            .map_err(|e| Error::Unknown(format!("Error saving new saved item: {}", e)))
    }
    ...
    fn upsert_item(&mut self, item: &UpsertSavedItem) -> Result<()> {
        ...
        diesel::insert_into(dsl::saved_items)
            ...
            .map(|_| ())
            .map_err(|e| Error::Unknown(format!("Failed to upsert saved item in DB: {}", e)))?;
    ...
    fn delete_item(&mut self, user_id: i32, pocket_id: &str) -> Result<()> {
        ...
        .execute(&*self.sqlite_conn)
        .map(|_| ())
        .map_err(|e| Error::Unknown(format!("Failed to delete saved item in DB: {}", e)))
    }
...
fn establish_connection(database_url: &str) -> Result<SqliteConnection> {
    SqliteConnection::establish(&database_url)
        .map_err(|e| Error::Unknown(format!("Error connecting to {}: {}", database_url, e)))
}

fn run_migrations(connection: &SqliteConnection) -> Result<()> {
    embedded_migrations::run_with_output(connection, &mut std::io::stdout())
        .map_err(|e| Error::Unknown(format!("Failed to run migrations: {}", e)))
}
